...
export const PRESET_PHOTO_TAG_SECTIONS = [
  ...
  {
    label: "Old Family",
    tags: ["aaron", "matthew", "samantha", "bella", "joseph"] as const,
  },
  {
    label: "Dive Buddies",
...
const PRESET_TAG_COLOR_CLASSES: Record<PresetPhotoTag, string> = {
  ...
  matthew:
    "border-blue-300 bg-blue-100 text-blue-900 dark:border-blue-500/40 dark:bg-blue-500/15 dark:text-blue-100",
  samantha:
