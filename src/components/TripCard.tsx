...
export function TripCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-stone-200/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-stone-300/80">
      <Link
      ...
      {isAdmin && onDelete && (
        <button
          ...
          disabled={deleting}
          className="absolute right-3 top-3 rounded-full bg-black/60 px-2.5 py-1 text-xs text-white opacity-0 transition-opacity hover:bg-red-600 group-hover:opacity-100 disabled:opacity-50"
        >
